...
export default function EditServicePage() {
    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          <p className="text-error-600 font-medium">Service not found</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold text-neutral-900">Edit Service</h1>
        <p className="mt-2 text-neutral-600">Update service information and pricing</p>
      </div>
