...
export class ConversationsController {
  ...
  async findAll(@CurrentUser('id') userId: string, @CurrentUser('role') userRole: string, @Query('salon_id') salonId?: string): Promise<ConversationResponseDto[]> {
  ...
  @ApiParam({ name: 'id' })
  @ApiResponse({ status: HttpStatus.OK, type: ConversationResponseDto })
  async findOne(@Param('id') id: string, @CurrentUser('id') userId: string, @CurrentUser('role') userRole: string): Promise<ConversationResponseDto> {
  ...
  @ApiParam({ name: 'id' })
  @ApiResponse({ status: HttpStatus.OK, type: ConversationResponseDto })
  async updateStatus(@Param('id') id: string, @CurrentUser('id') userId: string, @CurrentUser('role') userRole: string, @Body() updateStatusDto: UpdateConversationStatusDto): Promise<ConversationResponseDto> {
